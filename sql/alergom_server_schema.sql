CREATE DATABASE IF NOT EXISTS alergom_server DEFAULT CHARACTER SET 'cp850';
...
CREATE OR REPLACE TABLE cliente
    engine=CONNECT
    table_type=DBF
    file_name='E:/Repositorios/programador_prensas/dbfs/FC101000.DBF'
    readonly=1
;
...
CREATE OR REPLACE TABLE orden_produccion_item (
    ...
    engine=CONNECT
    table_type=DBF
    file_name= 'E:/Repositorios/programador_prensas/dbfs/%s.DBF'
;
...
CREATE OR REPLACE TABLE hoja_de_ruta
    engine=CONNECT
    table_type=DBF
    file_name= 'E:/Repositorios/programador_prensas/dbfs/COS75000.DBF'
    readonly=1
;
...
CREATE OR REPLACE TABLE operario
    engine=CONNECT
    table_type=DBF
    file_name= 'E:/Repositorios/programador_prensas/dbfs/COS70003.DBF'
    readonly=1
;
